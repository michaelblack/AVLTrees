...
In addition to insert and delete as demonstrated below, the tree supposts the folling functions: `height`, `makeLeaf`, `isEmpty`, `infold`, `postfold`, `prefold`, and `find`
